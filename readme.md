...
I've started to develop passion for conceptual meanings like understanding and meaning in the high school.

but the turning point was when in a online class, the teacher classified a question with answer of about 2 pages long as "*very simple*", it got me thinking  that "*what is the real measurement of simplicity?"*
...
<div style="text-align: center; height: 300px;">
  <img src="./assets/compiled/KLU-ven.png" alt="ven diagram of Understanding VS Learning VS Knowing">
</div>

- **Knowing** (K): remembering, like parrot
